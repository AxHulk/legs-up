...
const singleRows: (string | React.ReactNode)[][] = [
  ...
  ["Пилатес на реформере — сплит (мини-группа на 2)", "60 мин", <strong>4 000 ₽</strong>],
  ["Пилатес на реформере — группа", "60 мин", <strong>2 000 ₽</strong>],
  ["Пилатес на мате", "60 мин", "1 100 ₽"],
  ["Здоровая спина", "60 мин", "1 000 ₽"],
  ["3D ягодицы", "60 мин", "1 000 ₽"],
  ["Силовая тренировка", "60 мин", "1 000 ₽"],
  ["Функциональный тренинг", "60 мин", "1 000 ₽"],
  ["Тренировка TRX", "60 мин", "1 100 ₽"],
  ["Йога в гамаках", "60 мин", "1 100 ₽"],
  ["Растяжка в гамаках", "60 мин", "1 100 ₽"],
  ["Хатха-йога", "60 мин", "1 000 ₽"],
  ["Гибкость и МФР", "60 мин", "1 000 ₽"],
  ["Мобилити", "60 мин", "1 000 ₽"],
];

const packRows: (string | React.ReactNode)[][] = [
  ["Индивидуальные занятия на реформере", "8 занятий", "8 недель", <strong>22 400 ₽</strong>, "2 800 ₽"],
  ["Индивидуальные занятия на реформере", "4 занятия", "5 недель", <strong>11 600 ₽</strong>, "2 900 ₽"],
  ["Групповые занятия на реформере", "8 занятий", "8 недель", <strong>14 400 ₽</strong>, "1 800 ₽"],
  ["Групповые занятия на реформере", "4 занятия", "5 недель", <strong>7 900 ₽</strong>, "1 975 ₽"],
  ["Групповые занятия (кроме реформера)", "8 занятий", "8 недель", <strong>7 600 ₽</strong>, "950 ₽"],
  ["Групповые занятия (кроме реформера)", "4 занятия", "5 недель", <strong>3 900 ₽</strong>, "975 ₽"],
];
