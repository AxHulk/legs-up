...
const programs: Program[] = [
  ...
  },
  {
    ...
    what:
      "Продвинутый уровень. Сложные комбинации упражнений, интенсивная проработка всех мышечных групп, работа с балансом и координацией. Новые вызовы для тела, где привычные движения раскрываются по-новому.",
    points: [
  ...
  },
  {
    ...
    what:
      "Специальная программа для коррекции осанки и здоровья позвоночника. Укрепление мышц спины и кора, снятие напряжения в шее и плечах, работа с балансом, стабильностью и лёгкостью движений.",
    points: [
  ...
  },
  {
    ...
    what:
      "Комплексная проработка ягодиц в трёх плоскостях — тянущие, толкающие и ротационные упражнения. Отсюда и название 3D: включаются все три ягодичные мышцы для гармоничного развития и формы.",
    points: [
  ...
  },
  {
    ...
    what:
      "Функциональная тренировка с петлями TRX — работа с весом собственного тела. Развиваем силу, баланс и выносливость одновременно, включая глубокие мышцы-стабилизаторы в каждом движении.",
    points: [
  ...
  },
  {
    ...
    what:
      "Интенсивная тренировка на максимум — работа с весами, функциональные упражнения и кардио-интервалы. Высокий темп и постоянная смена активностей. 55 минут, после которых вы почувствуете себя сильнее.",
    points: [
  ...
  },
  {
    ...
    what:
      "Универсальная тренировка, сочетающая силовую нагрузку и глубокую растяжку в одном занятии. Сильные и гибкие одновременно — идеальный выбор для тех, у кого мало времени, но есть цель.",
    points: [
  ...
  },
  {
    ...
    what:
      "Динамичная практика, где йога встречается с силовым тренингом. Удержание сложных поз, плавные переходы и контроль дыхания. Тело становится сильнее с каждым занятием при полной концентрации.",
    points: [
  ...
  },
  {
    ...
    what:
      "Тренировка на развитие подвижности суставов и амплитуды движений. Разблокировка зажатых зон, улучшение качества движения в повседневной жизни. Профилактика травм и скованности.",
    points: [
  ...
  },
  {
    ...
    what:
      "Комплексная растяжка всех групп мышц. Улучшение подвижности суставов, гибкости и эластичности связок. Расслабление, снятие напряжения и зажимов после рабочего дня — тело оживает и дышит.",
    points: [
  ...
  },
  {
    ...
    what:
      "Медитативная практика, сочетающая растяжку с элементами йоги в невесомости. Асаны йоги, декомпрессия позвоночника и полное расслабление. Перевёрнутые позы дарят новый взгляд на мир.",
    points: [
  ...
  },
  {
    ...
    what:
      "Медитативная практика расслабления и растяжки в невесомости. Эффект полёта, декомпрессия позвоночника и глубокая работа с телом без нагрузки на суставы. Снятие стресса и ощущение лёгкости.",
    points: [
